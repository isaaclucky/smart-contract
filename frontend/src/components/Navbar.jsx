    ...
    <AppBar position="sticky">
      <StyledToolbar>
        ...
        <Icons>
          ...
          <Avatar sx={{ width: 30, height: 30 }} src="https://vanishingportrait.com/wp-content/uploads/2019/05/tiffanytrenda-vanishingportrait-identity.jpg"  onClick={e=>setOpen(true)} />
        </Icons>
